---
title: "Ranking of Hospitals based on Mortality Rates"
...
The function reads the outcome-of-care-measures.csv file and returns a character vector with the name of the hospital that has the ranking specified by the num argument and the disease specified by the coutcome arguement.
